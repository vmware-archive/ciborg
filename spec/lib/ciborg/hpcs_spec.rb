...
describe Ciborg::Hpcs, :slow do
  ...
  describe "#create_security_group" do
    after { hpcs.fog_security_groups.get(hpcs.fog_security_group_name_to_id(security_group)).destroy if SpecHelpers::hpcs_credentials_present? }
  ...
  describe "#add_key_pair" do
    ...
    after { hpcs.delete_key_pair(key_pair_name) if SpecHelpers::hpcs_credentials_present? }
